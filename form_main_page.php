...
<head>
    ...
    <title>Текст для главной страницы</title>
    <!-- Bootstrap -->
...
<div class="container technical-task">
    ...
    <div class="row">
        <h2 class="text-center">Текст для главной страницы</h2>
        ...
        <form action="/mailsend_main_page.php" method="post" id="tt-main-page">
            ...
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    <label for="tt-message" class="control-label label-required">4.Главный посыл, который должен почувствовать читатель (возможно несколько посылов)
            </label>
                    <textarea placeholder="Солидная компания, дружелюбная компания, здесь очень низкие цены
" class="form-control" id="tt-message" name="tt-message" rows="2">
            </textarea>
                </div>
                <div class="form-group">
            <label for="tt-target-group" class="control-label">5.Целевая аудитория текста (основные покупатели)</label>
            <input type="text" class="form-control" id="tt-target-group" placeholder="Мужчины 25-35 лет с автомобилей" name="tt-target-group">
        </div>
                <div class="form-group">
            <label for="tt-symbol-number" class="control-label">6.Количество символов (примерно)</label>
            <input type="number" class="form-control" id="tt-symbol-number" placeholder="2000-2500" name="tt-symbol-number">
        </div>
                <div class="radio">
            <label class="control-label radio-label label-required" for="tt-text-compact-yes">7.Возможно ли увеличение или уменьшение объема статьи?</label><br>
            <label class="radio-inline">
                <input type="radio" name="tt-text-compact" id="tt-text-compact-yes" value="option1">Да
            </label>
            <label class="radio-inline">
                ...
                <div class="form-group">
            <label for="tt-important-parts" class="control-label label-required">8.Моменты, которые обязательно должны быть отражены в материале
            </label>
            <textarea placeholder="Мощный, стильный, безопасный" class="form-control" id="tt-important-parts" name="tt-important-parts" rows="2" required></textarea>
        </div>
                <div class="form-group">
            <label for="tt-еxcluded-words" class="control-label label-required">9.Чего точно НЕ должно быть в тексте?
            </label>
            <textarea placeholder="Слов-паразитов, цены" class="form-control" id="tt-еxcluded-words" name="tt-еxcluded-words" rows="2" required></textarea>
        </div>
                <div class="form-group">
            <label for="tt-еxcluded-words" class="control-label label-required">10.Есть ли у вас какие-то реальные преимущества, которые выделяют вас среди прочих?
            </label>
            <textarea placeholder="Уникальный дизайн" class="form-control" id="tt-еxcluded-words" name="tt-еxcluded-words" rows="2" required></textarea>
        </div>
            </div>
    ...
    <!-- second row -->
            ...
            <div class="col-sm-6 col-xs-12">
        <div class="form-group">
            <label for="tt-details" class="control-label label-required">11.Напишите любые, пусть даже малозначительные факты, цифры и достижения, которые могут придать индивидуальности вашему материалу (приветствуются все, даже самые малозначительные, но конкретные данные). Это крайне важно.
            </label>
            <textarea placeholder="Уже 50 лет на рынке, каждый рубль из 30 заработанных мы отправляем на благотворительность и т.п." class="form-control" id="tt-details" name="tt-details" rows="2" required></textarea>
        </div>
        <div class="form-group">
            <label for="tt-words-excluded" class="control-label">12.Слова-исключения (возможно, есть слова, которые не стоит употреблять в статье)</label>
            <textarea placeholder="Суперский,  нереальный, крутотень" class="form-control" id="tt-words-excluded" name="tt-words-excluded"></textarea>
        </div>
        <div class="form-group">
            <label for="tt-text-style" class="control-label">13.Стиль написания</label>
            <input type="text" class="form-control" id="tt-text-style" placeholder="Деловой, ироничный, с  элементами юмора, провокационный, новостной" name="tt-text-style">
        </div>
        <div class="radio">
            <label for="tt-headers-yes" class="control-label radio-label">14.Нужны ли подзаголовки?</label><br>
            <label class="radio-inline">
                <input type="radio" name="tt-headers" id="tt-headers-yes" value="Yes">Да
            </label>
            <label class="radio-inline">
        ...
        <div class="form-group">
            <label for="tt-deadline" class="control-label label-required">15.Пожелания относительно сроков подготовки материала</label>
            <textarea placeholder="До 12-00 пятницы 01.01.16г" class="form-control" name="tt-deadline" rows="2" id="tt-deadline" required></textarea>
        </div>
        <div class="form-group">
            <label for="tt-additional" class="control-label">16.Дополнительные пожелания</label>
            <textarea placeholder="Дополнительные пожелания" class="form-control" id="tt-additional" name="tt-additional"></textarea>
        </div>
    </div>
            <div class="col-sm-12 col-xs-12">
        <div class="form-group">
            <input type="hidden" value="Текст для главной страницы" name="cat">
            <input type="file" value="Прикрепить файл">
        </div>
        <div class="form-group">
            <input type="submit" class="btn btn-primary" value="Отправить" name="submit-copy">
